...
public interface InvoiceDetailedService {
     ...
     * 按条件查询酬金计提明细管理表（分页）
     */
    Page<InvoiceRewardDetailedResVO> getPageByCont(InvoiceDetailedVO cond, Integer pageNum, Integer pageSize);
     ...
     * 获取导出列表所需数据
     */
    List<InvoiceDetailedExportVO> getListByCont(InvoiceDetailedVO cond);
